...
- Use commonly used formats (Powerpoint) or open formats such as markdown documents (PDF)
...
- **Thank you** very much to [Esther](https://estherplomp.github.io/) [Plomp](mailto:e.plomp@tudelft.nl) and [Lennart](https://lennartwittkuhn.com/) [Wittkuhn](mailto:lennart.wittkuhn@uni-hamburg.de) whose slides we used and developed!
